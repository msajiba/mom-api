...
const saveDataToJson = async (id, filepath, outputFileExtension) => {
  const outputFilePath = filepath + id + outputFileExtension;
  const pdfToolsFilesPath = filepath + id + "/";
...
const saveDataToServer = async (id, filepath, outputFileExtension) => {
  const outputFilePath = filepath + id + "/" + id + outputFileExtension;
  const pdfToolsFilesPath = filepath + id + "/";
  const dataJSONPath = pdfToolsFilesPath + id + ".json";
